      ...
      <div className="w-full max-w-md">
        <div className="glass-card rounded-xl p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {errorMessage && (
              <div className="text-sm text-red-400 text-center bg-red-500/10 border border-red-500/30 rounded-md py-2 px-3">
                {errorMessage}
              </div>
            )}
            {!isLoginView && (
            ...
            <div>
              ...
              {!isLoginView && (
                <p className="text-xs text-gray-500 mt-1">Use at least 8 characters for a strong password.</p>
              )}
            </div>
            <div>
          ...
          <div className="text-center mt-6">
            <button onClick={toggleView} className="text-sm text-blue-400 hover:text-blue-300">
